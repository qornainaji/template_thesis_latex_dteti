...
teori (\textit{theory-driven prompt manual}) untuk menciptakan 
...
\toprule
\textbf{Category} & \textbf{Subcategory} & \textbf{Tinggi (2)} & \textbf{Sedang (1)} & \textbf{Rendah (0)} \\
\midrule
...
% partial horizontal rule across the three score columns:
\cmidrule(lr){2-5}
...
\begin{enumerate}
    ...
    \item \textbf{(RQ 1)} Sejauh mana efektivitas metode \textit{context 
