...
\textit{Self-Regulated Learning} (SRL) dalam lingkungan berbasis 
Kanban , teori umpan balik formatif, serta kerangka motivasi 
...
di bidang pendidikan. Dalam konteks pendidikan, LLM dimanfaatkan untuk
menghasilkan materi pembelajaran yang dipersonalisasi, memberikan umpan balik
otomatis kepada siswa, serta mendukung sistem tanya jawab interaktif.
...
% \subsubsection{\textit{Context Engineering}}
