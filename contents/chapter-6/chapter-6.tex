...
\begin{enumerate}
    ...
    \item Mengembangkan evaluasi ahli manusia dengan
    dengan menggunakan A/B testing, di mana
    ahli menilai dua variasi umpan balik yang dihasilkan
    sehingga dapat membandingkan serta memilih variasi
    yang terbaik secara langsung.
